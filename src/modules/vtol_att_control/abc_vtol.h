...
static constexpr float ABC_B_TRANS_THRUST_BLENDING_DURATION = 0.5f;
...
public:
     ...
     */
    AbcVtol(VtolAttitudeControl *_att_controller);

    /// @brief 析构函数（使用默认实现）
    ~AbcVtol() override = default;
